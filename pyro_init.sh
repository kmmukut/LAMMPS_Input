...
#./pyro_init.sh C12H26 CCCCCCCCCCCC 30 0.1 E_165_00_1_010
...
size=$(((1.0e10)*(($m1*$n1)/(6.023e29*$density))**(1.0/3.0)))
echo 'box density  = ' "${4} gm/cc"
echo 'box dimension  = ' "${size} A"

echo 'Creating PACKMOL input file: '

echo "  
        # A mixture of $3 $1 molecules
        # 
...
head -n $(($key + 1)) intermediate > $3$1_0$dens_rep.data  
